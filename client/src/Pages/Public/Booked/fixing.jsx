                        ...
                        <div className="px-[20px]">
                            ...
                            <div className="flex justify-end pb-[20px]">
                                <div className="text-[14px]">
                                    ...
                                    <button onClick={() => setIsModalVisible(!isModalVisible)} className="text-gray-700 border border-gray-700 mx-[7px] bg-white rounded-[5px] px-[10px] py-[6px] ">
                                        Liên hệ
                                    </button>
                    ...
                    >
                        ...
                        <div className="mt-[15px]">
                            <p className="text-[14px] mb-[5px]">
                                Mã đơn hàng: <span className="text-red-500">HGBHVG666</span>
                            </p>
                            <form action="">
