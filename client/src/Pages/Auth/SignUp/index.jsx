          ...
          <div className="md:grid grid-cols-2">
            <div className="px-[15px] sm:px-[30px] text-center md:text-left lg:pr-[90px] lg:pl-[100px]">
              ...
              <form action="" className="mt-[45px]">
                ...
                <button className="bg-[#6dabe4] px-[39px] mt-[20px] py-[15px] border-none rounded-[5px] text-[14px] text-white">
                  Register
                </button>
              </form>
              <Link
            ...
            <div className="hidden md:block pl-[30px] pr-[30px] lg:pl-[45px] lg:pr-[20px] mt-[10px]">
              ...
              <Link
                to=""
                className="block text-center mt-[40px] text-gray-700 underline hover:text-blue-700"
              >
                I am already member
              </Link>
            </div>
